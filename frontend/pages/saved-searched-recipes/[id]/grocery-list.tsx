    ...
    const fetchGroceryList = async () => {
      try {
        const res = await axios.get(
          `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/saved-recipes/${id}/grocery-list`
        );
  ...
  async function handleEmailClick() {
    ...
    try {
      ...
      const res = await axios.post(
        `${process.env.NEXT_PUBLIC_API_BASE_URL}/api/grocery-list/email`,
        payload
      );
                  ...
                  >
                    <CardBody py={3}>
                      <Flex justify="space-between" align="center" gap={2}>
                        ...
                        <Box flex="1" minW={0}>
                          ...
                          >
                            <Text
                              ...
                              noOfLines={2} // ✅ prevents pushing button down, wraps within area
                        ...
                        {/* Right side: delete button stays aligned */}
                        <IconButton
